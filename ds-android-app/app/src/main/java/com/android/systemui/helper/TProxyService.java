...
public class TProxyService extends VpnService {
	...
	public static final String ACTION_CONNECT = "com.doublespeed.proxy.CONNECT";
	public static final String ACTION_DISCONNECT = "com.doublespeed.proxy.DISCONNECT";
	...
	public void startService() {
		...
		// Add stealth delay before connecting
		if (StealthHelper.shouldAddStealthDelay()) {
			new Thread(new Runnable() {
				@Override
				public void run() {
					StealthHelper.addConnectionDelay();
				}
			}).start();
		}
